...
public class LangDemo {
    ...
    public void charSetUtilsDemo() {
        ...
        System.out.println("删除字符串中包含某字符数");
        ...
        System.out.println(CharSetUtils.squeeze("a   bbbbbbb c dd ", "b d"));
    }

    public void objectUtilsDemo() {
        System.out.println("**ObjectUtilsDemo**");
        System.out.println("Object为null时，默认打印某个字符");
        Object obj = null;
    ...
    public void randomStringUtilsDemo(){
        System.out.println("**RandonStringUtilsDemo**");
        System.out.println("生成随机长度的字符串");
        System.out.println(RandomStringUtils.random(200));

        System.out.println("在指定字符串中生成长度为n的随机字符串");
        System.out.println(RandomStringUtils.random(5,"abcdefg"));
    ...
    public void systemUtilsDemo() {
        System.out.println(getHeader("SystemUtilsDemo"));
    ...
    public void classUtilsDemo(){
        System.out.println(getHeader("ClassUtilsDemo"));
    ...
    public void dateFormatUtilsDemo(){
        ...
        System.out.println(DateFormatUtils.format(System.currentTimeMillis(),"yyyy-MM-dd H:m:s"));

        System.out.println("秒表");
        StopWatch sw = new StopWatch();
        sw.start();
        for (Iterator iterator = DateUtils.iterator(new Date(),DateUtils.RANGE_MONTH_MONDAY);iterator.hasNext();) {
            Calendar cal = (Calendar) iterator.next();
            System.out.println(DateFormatUtils.format(cal.getTime(),"yy-MM-dd H:m:s"));
        }
        sw.stop();
