...
<script type="text/javascript">
  $("#jsp_admin_role_datagrid").datagrid({
    ...
    onClickRow:function(rowIndex, rowData){
        ...
        $("#jsp_admin_yhgl_updateDiarole").diarole("open");
    },
    frozenColumns:[[
      {
        field:'id',
  ...
  function append(){
    ...
    $("#jsp_admin_role_addDiarole").diarole('open');
  }
  function remove(){
...
<div id="jsp_admin_role_addDiarole" data-options="closed:true,modal:true,
                            ...
                            $('#jsp_amdin_role_addForm').form('submit',{
                                ...
                                success:function(r){
                                    ...
                                    if(obj.result == 1){
                                        ...
                                        $('#jsp_admin_role_addDiarole').diarole('close');
                                    }
                                    if(obj.result == 2){
                                        $('#jsp_admin_role_addDiarole').diarole('close');
                                    }
                    ...
                    }]" class="easyui-diarole" style="width: 600px;height: 250px;">
  <form id="jsp_amdin_role_addForm">
    <table>
      ...
      <tr>
        ...
        <td>
          <textarea id="jsp_admin_role_addFrom_commom" name="common" class="textarea easyui-validatebox" data-options="required:true" style="width: 500px;"></textarea>
          <%--<input id="jsp_amdin_role_addForm_common" name="common" class="easyui-validatebox" data-options="required:true" style="height: 200px;width:500px"/>--%>
        </td>
      </tr>
    </table>
  </form>
</div>
<div id="jsp_admin_yhgl_updateDiarole" data-options="closed:true,modal:true,title:'查看内容'" class="easyui-diarole" style="width: 500px;height: 300px;">
    <table>
        <tr>
            <th>姓名</th>
            <td><input id="jsp_admin_role_name" readonly/></td>
            <th>所属项目</th>
            <td><input id="jsp_admin_role_project_name" readonly/></td>
        </tr>
        <tr>
            <th>日志内容</th>
            <td colspan="3">
                <textarea id="jsp_admin_role_commom"class="textarea" data-options="required:true" style="width:346px;"></textarea>
            </td>
        </tr>
    </table>
</div>